...
export async function generateFeedbackGuidePdf(params: {
  ...
  await drawBrandLogo(doc, branding?.logo_url, 20, 15, 90, 70, { centerY: true });
  doc.setTextColor(255,255,255);
  doc.setFontSize(17); doc.text('Ferramenta de Feedback ao Colaborador', 125, 48);
  doc.setFontSize(11); doc.text(`Empresa: ${empresa}`, 125, 72);
