...
- TABELA CANÔNICA OBRIGATÓRIA (use EXATAMENTE estes códigos quando o cargo corresponder; não substitua por "publicitário" 254105/253105 nem por outro código parecido):
  ...
  • Gerente de hotel / pousada / resort / hotel fazenda / subgerente de hotel / administrador de hospedagem → 141505 — Gerente de hotel (família 1415 — Gerentes de operações de serviços em empresa de turismo, de alojamento e alimentação). NUNCA use 141410 nem qualquer código da família 1414 para gerência hoteleira.
  • Gerente de restaurante / de alimentos e bebidas (A&B) → família 1415 (ex.: 141510 — Gerente de restaurante)
  • Camareira de hotel → 514320; Governanta de hotel (chefia de governança) → 514105 ou ocupação equivalente confirmada pela base oficial
- HOTELARIA / MEIOS DE HOSPEDAGEM (hotel, pousada, resort, hostel): cargos de recepção, reservas, hospedagem, governança, camareira, mensageiro e concierge pertencem às famílias de ATENDIMENTO/HOSPEDAGEM (4201, 4221, 5134, 5143 e correlatas) ou de GERÊNCIA HOTELEIRA (1415). É TERMINANTEMENTE PROIBIDO classificar "Chefe de recepção", "Supervisor de recepção", "Gerente de hotel/pousada" ou cargos de hospedagem em famílias de COMUNICAÇÃO, MARKETING, PUBLICIDADE ou RELAÇÕES PÚBLICAS (1423 — Gerente de comunicação, 2531, 2534 e correlatas). "Recepção" em hotelaria é atendimento a hóspedes, nunca comunicação corporativa.
- CALIBRAGEM OBRIGATÓRIA DO CÓDIGO: só informe um código de 6 dígitos que (a) conste na lista de candidatos oficiais do MTE acima, (b) conste na TABELA CANÔNICA, ou (c) você tenha certeza absoluta de existir na CBO 2002 com o título que você escreveu. Se não tiver certeza do código exato, prefira o candidato oficial mais aderente em vez de "chutar" um número parecido. Um código inexistente ou de família errada é considerado ERRO GRAVE.
