...
// O site oficial NUNCA é adivinhado: só é preenchido quando consta na própria CCT
// enviada (URL no texto ou domínio de e-mail). Caso contrário fica em branco para
